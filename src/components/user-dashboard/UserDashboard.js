  ...
  useEffect(() => {
    ...
    const fetchArticles = async () => {
      try {
        ...
        const response = await fetch("https://blog-backend-5.onrender.com/user-api/articles", {
          method: "GET",
          headers: {
...
//       const response = await fetch(`https://blog-backend-5.onrender.com/user-api/articles/${articleId}/comment`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${token}`,
...
//       // Ensure the comment has a valid ID before adding it to the state
//       if (!result.comment.commentId) {
//         console.error("Backend didn't provide a commentId");
...
//       const response = await fetch(`https://blog-backend-5.onrender.com/user-api/articles/${articleId}/like`, {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${token}`,
...
//       const response = await fetch(`https://blog-backend-5.onrender.com/user-api/comments/${commentId}`, {
//         method: "PUT",
//         headers: {
//           "Content-Type": "application/json",
//           Authorization: `Bearer ${token}`,
...
//   // If not authenticated, don't render anything (the useEffect will handle redirection)
